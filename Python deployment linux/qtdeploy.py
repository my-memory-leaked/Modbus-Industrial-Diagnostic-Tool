...
# Define paths
app_binary = '/home/karol/Repositories/Modbus-Industrial-Diagnostic-Tool/build/build-Modbus-Industrial-Diagnostic-Tool-Desktop_Qt_6_5_3_GCC_64bit-Release/exe/YourAppName'  # Replace 'YourAppName' with your actual app name
qt_base_dir = '/home/karol/Qt/6.5.3/gcc_64'  # Adjust if needed
deployment_dir = os.path.dirname(app_binary)  # Deployment directory is the same as the binary's directory
...
# Copy dependencies (Qt libraries and other linked libs)
for lib in dependencies:
    if qt_base_dir in lib:  # Copy only Qt-related libraries
